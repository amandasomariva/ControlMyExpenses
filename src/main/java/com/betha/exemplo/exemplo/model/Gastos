...
@Entity
public class Gastos extends AbstractEntity {
    ...
    @Transient
    private Set<Gastos> seguidores;
    @Transient
    private Set<Gastos> seguindo;
  ...
  //  }
    ...
    public Set<Gastos> getSeguidores() {
        return seguidores;
    }

    public void setSeguidores(Set<Gastos> seguidores) {
        this.seguidores = seguidores;
    }

    public Set<Gastos> getSeguindo() {
        return seguindo;
    }

    public void setSeguindo(Set<Gastos> seguindo) {
